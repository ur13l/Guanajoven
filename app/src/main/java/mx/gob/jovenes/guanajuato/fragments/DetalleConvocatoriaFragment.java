...
public class DetalleConvocatoriaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        convocatoria = new Convocatoria(args.getInt("idConvocatoria", convocatoria.getIdConvocatoria()),
                                        args.getString("titulo", convocatoria.getTitulo()),
                                        args.getString("descripcion", convocatoria.getDescripcion()),
                                        args.getString("rutaImagen", convocatoria.getRutaImagen()),
                                        args.getString("fechaInicio", convocatoria.getFechaInicio()),
                                        args.getString("fechaCierrre", convocatoria.getFechaCierre()),
                                        args.getInt("estatus", convocatoria.getEstatus()));
